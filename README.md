...
Key questions such as: **Problem Areas to Explore:**
...
Total Listings per City (Bar Chart)

Average Price by City (Card or KPI)

Average Reviews per Listing (Card)

Map of all listings (Map Chart using Latitude & Longitude)

Total Available Days (Card)

Insights & Storytelling

In your report/presentation, answer:

Which city has more listings?

Which neighbourhoods are most popular?

How do prices differ across cities?

Are more reviews linked to cheaper or expensive listings?
...
Screenshots / Demos
Show what the dashboard looks like. --: https://github.com/VisheshSingh414/Airbnb-Analysis/blob/main/Airbnb%20project%20analysis.png?raw=true
